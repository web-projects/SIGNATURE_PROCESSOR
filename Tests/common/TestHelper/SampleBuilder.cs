using IPA5.XO.Common.DAL;
using IPA5.XO.Requests;
using IPA5.XO.Requests.DAL;
using IPA5.XO.Requests.Payment;
using IPA5.XO.Responses;
using IPA5.XO.Responses.DAL;
using IPA5.XO.Responses.Payment;
using System;
...
namespace TestHelper
{
    public static class SampleBuilder
    {
        ...
        public static IPA5.XO.ProtoBuf.CommunicationHeader ServicerHeader() =>
            new IPA5.XO.ProtoBuf.CommunicationHeader()
            {
                Flags = new IPA5.XO.ProtoBuf.CommFlags(),
                CommIdentifiers = { new IPA5.XO.ProtoBuf.CommIdentifier()
                {
                    DnsName = "DNSName",
                    Service = IPA5.XO.ProtoBuf.ServiceType.Receiver
                } }
            };
    }
}
